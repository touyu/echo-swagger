...
### Start using it
1. Add comments to your API source code, [See Declarative Comments Format](https://github.com/touyu/swag#declarative-comments-format).
2. Download [Swag](https://github.com/touyu/swag) for Go by using:
```sh
$ go get github.com/touyu/swag/cmd/swag
```
3. Run the [Swag](https://github.com/touyu/swag) in your Go project root folder which contains `main.go` file, [Swag](https://github.com/touyu/swag) will parse comments and generate required files(`docs` folder and `docs/doc.go`).
